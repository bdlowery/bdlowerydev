...
<article class="max-w-5xl mx-auto px-14 sm:px-16">
	<header class="page-header my-10 relative z-10 py-10 bg-cover bg-center rounded-lg overflow-hidden" style="background-image: url('<?= $projectHeaderImage ?>');">
