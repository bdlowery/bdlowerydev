	...
	<div class="container max-w-5xl mx-auto px-4 sm:px-16">
		<div class='grid gap-14 py-14 sm:py-20 sm:gap-20'>
			...
			<div>
				...
				<div class="flex flex-col sm:flex-row gap-12 mt-10">
					<div>
					...
					<div>
						...
						<ul class='list-disc pl-8 space-y-1 mt-1'>
							<li>B.S. in Computer Science from <a class='decoration-sky-500 hover:text-sky-500 hover:no-underline underline' href="https://www.csus.edu/">CSUS</a></li>
				...
				<div class='mt-10'>
					<h2 class='font-medium text-lg'>Some projects</h2>
